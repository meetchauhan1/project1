...
mongoose.connect("mongodb+srv://meetchauhan240:niravmeet@cluster0.cfzl2sk.mongodb.net/e-commerce");
...
const fetchUser = async(req,res,next)=>{
    ...
    if(!token){
        ...
        try {
            ...
            res.status(401).send({errors:"please authenicate using valid user"})
